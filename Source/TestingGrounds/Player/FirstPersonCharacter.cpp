...
void AFirstPersonCharacter::BeginPlay()
{
	...
	{
		UE_LOG(LogTemp, Error, TEXT("No rifle class on player"));
	}
...
void AFirstPersonCharacter::OnFire()
{
	...
	if(Gun)
		bApplyRecoil = Gun->Fire();


	// try and play a firing animation if specified
	if(FireAnimation != nullptr && bApplyRecoil)
		PlayRecoilAnimation();
}
...
void AFirstPersonCharacter::SetGenericTeamId(const FGenericTeamId & TeamID)
{
	this->TeamId = TeamID;
}
...
void AFirstPersonCharacter::PlayRecoilAnimation()
{
